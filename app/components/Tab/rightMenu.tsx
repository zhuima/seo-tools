 ...
 * @LastEditTime: 2024-06-06 17:49:56
              ...
              {Object.entries(tabMap).map(([name, slug]) => {
                return (
                  ...
                  <button
                    ...
                    className="block w-full text-left  cursor-default select-none relative py-2 pl-3 pr-9 hover:bg-orange-400 hover:text-gray-900  text-sm"
                  >
                    {name}
                  </button>
                );
